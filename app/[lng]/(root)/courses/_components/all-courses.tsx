      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          ...
          <Select onValueChange={onUpdateParams}>
            <SelectTrigger className="w-[calc(50%-4px)] min-w-[110px] flex-1 bg-gradient-to-r from-secondary to-background sm:w-[120px] sm:flex-none">
          ...
          <Select onValueChange={onUpdateParams}>
            <SelectTrigger className="w-[calc(50%-4px)] min-w-[110px] flex-1 bg-gradient-to-l from-background via-secondary to-background sm:w-[120px] sm:flex-none">
          ...
          <Select onValueChange={onUpdateParams}>
            <SelectTrigger className="w-full min-w-[110px] flex-1 bg-gradient-to-l from-secondary to-background sm:w-[120px] sm:flex-none">
